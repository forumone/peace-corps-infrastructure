...
resource "aws_security_group" "admin" {
  ...
  ingress {
    ...
    to_port = 80
    protocol = "tcp"
    cidr_blocks = ["159.142.0.0/16", "65.205.231.0/24", "72.37.171.131/32", "72.37.171.132/32", "80.254.156.99/32", "80.254.156.100/32", "0.0.0.0/0"]
  }
  ...
  ingress {
    ...
    to_port = 22
    protocol = "tcp"
    cidr_blocks = ["159.142.0.0/16", "65.205.231.0/24", "72.37.171.131/32", "72.37.171.132/32", "80.254.156.99/32", "80.254.156.100/32"]
  }
}