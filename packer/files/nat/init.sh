...
aws s3 cp s3://peacecorps-secrets/${environment}/paygov/${paygov_domain}.key.enc /tmp/${paygov_domain}.key.enc
...
aws s3 cp s3://peacecorps-secrets/${environment}/paygov/${paygov_domain}.chained.crt.enc /tmp/${paygov_domain}.chained.crt.enc
