...
aws s3 cp s3://${aws_secret_bucket_name}/${environment}/${role}/${domain_name}.key.enc /tmp/${domain_name}.key.enc
...
aws s3 cp s3://${aws_secret_bucket_name}/${environment}/${role}/${domain_name}.chained.crt.enc /tmp/${domain_name}.chained.crt.enc
...
aws s3 cp s3://${aws_secret_bucket_name}/${environment}/all/pubring.gpg.enc /tmp/pubring.gpg.enc
...
aws s3 cp s3://${aws_secret_bucket_name}/${environment}/all/trustdb.gpg.enc /tmp/trustdb.gpg.enc
...
if [ $role = "paygov" ]; then
    aws s3 cp s3://${aws_secret_bucket_name}/${environment}/${role}/secring.gpg.enc /tmp/secring.gpg.enc
...
if [ $role = "admin" ]; then
    ...
    aws s3 cp s3://${aws_secret_bucket_name}/${environment}/admin/ssh_host_dsa_key.enc /tmp/ssh_host_dsa_key.enc
    openssl aes-256-cbc -d -a -salt -pass pass:${decryption_key} -in /tmp/ssh_host_dsa_key.enc -out /etc/ssh/ssh_host_dsa_key

    aws s3 cp s3://${aws_secret_bucket_name}/${environment}/admin/ssh_host_dsa_key.pub.enc /tmp/ssh_host_dsa_key.pub.enc
    openssl aes-256-cbc -d -a -salt -pass pass:${decryption_key} -in /tmp/ssh_host_dsa_key.pub.enc -out /etc/ssh/ssh_host_dsa_key.pub


    aws s3 cp s3://${aws_secret_bucket_name}/${environment}/admin/ssh_host_ecdsa_key.enc /tmp/ssh_host_ecdsa_key.enc
    openssl aes-256-cbc -d -a -salt -pass pass:${decryption_key} -in /tmp/ssh_host_ecdsa_key.enc -out /etc/ssh/ssh_host_ecdsa_key

    aws s3 cp s3://${aws_secret_bucket_name}/${environment}/admin/ssh_host_ecdsa_key.pub.enc /tmp/ssh_host_ecdsa_key.pub.enc
    ...
    aws s3 cp s3://${aws_secret_bucket_name}/${environment}/admin/ssh_host_rsa_key.enc /tmp/ssh_host_rsa_key.enc
    openssl aes-256-cbc -d -a -salt -pass pass:${decryption_key} -in /tmp/ssh_host_rsa_key.enc -out /etc/ssh/ssh_host_rsa_key

    aws s3 cp s3://${aws_secret_bucket_name}/${environment}/admin/ssh_host_rsa_key.pub.enc /tmp/ssh_host_rsa_key.pub.enc
